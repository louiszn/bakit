...
BakitClient provides some options to configure command system:

| Option                | Type                                                                        | Description                                                         | Default |
| --------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------- | ------- |
| prefixes              | (string \| [GetPrefixFunction](/docs/api/type-aliases/GetPrefixFunction))[] | The prefix or prefixes to listen for prefix commands.               | -       |
| allowMentionPrefix    | boolean                                                                     | Allow bot mention as prefix.                                        | `false` |
| getSyntaxErrorMessage | GetSyntaxErrorMessageFunction                                               | A function that returns a message to send when syntax error occurs. | -       |
